...
//  res.cookie('color1', '', { expires: new Date(0) });
//  res.cookie('color2', '', { expires: new Date(0) });
//  res.cookie('color3', '', { expires: new Date(0) });
...
app.all('/login2',(req,res)=>{
 console.log('login2..');
 res.cookie('id',"hihihi",{maxAge:600000});
 res.cookie('pw',"1234",{maxAge:600000});
 res.redirect('/');
});
